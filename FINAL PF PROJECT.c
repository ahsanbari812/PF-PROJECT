...
void load();// mahnoor
int life;
void Delay(long double);//ahmed
void Move();//ahmed
void Food(); //Ahsan
int Score(); //ahsan
void Print();//ahsan
void gotoxy(int x, int y);//ahmed
void GotoXY(int x,int y);//ahmed
void Bend(); //ahmed
void Border();//mahnoor
void Down();//mahnoor
...
int main()
{
    ...
    Border();//Border of the play board//
...
void Print()//print a welcome message for player//
{
    printf("SNAKE GAME PROJECT BY AHSAN,MAHNOOR and AHMED\n\n");
